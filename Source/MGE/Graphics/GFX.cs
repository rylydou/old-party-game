...
namespace MGE.Graphics
{
	public static class GFX
	{
		...
		public static void DrawLine(Vector2 position, float length, Color color, float angle = 0.0f, float thickness = 1.0f)
		{
			...
			sb.Draw(pixel, position * currentPixelsPerUnit - Vector2.Perpendicular(Vector2.FromAngle(angle)) * thickness / 2, null, color, angle, Vector2.zero, new Vector2(length, thickness) * currentPixelsPerUnit, SpriteEffects.None, 0);
		}
